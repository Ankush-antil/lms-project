                                            ...
                                            <div className="space-y-4">
                                                ...
                                                {loadingMaterials ? (
                                                    ...
                                                    <div className="relative group/scroll-container w-full">
                                                        <style>{`
                                                            #teacher-study-materials-scroll-container::-webkit-scrollbar {
                                                                display: none;
                                                            }
                                                        `}</style>
                                                        {/* Left Arrow */}
                                                        {filteredMaterials.length > 5 && (
                                                            <button
                                                                type="button"
                                                                onClick={() => {
                                                                    const container = document.getElementById('teacher-study-materials-scroll-container');
                                                        ...
                                                        {/* Scrollable Flex Row */}
                                                        <div
                                                            id="teacher-study-materials-scroll-container"
